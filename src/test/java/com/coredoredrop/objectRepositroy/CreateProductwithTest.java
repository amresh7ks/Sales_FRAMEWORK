...
import com.sales.product.CreateProductTest;
...
public class CreateProductwithTest {
	...
	public static void main(String[] args) throws IOException {
		...
		//read the  data common data  for the property  file
  		...
  		//weDriverUtility.switchToAlertWindowAndAccept(driver);	
  		weDriverUtility.switchTo_Alert_Accept(null);
  		commonPage.clickProduct();
  		addProductpage.ClickonAddIconForProduct();
  		addProductpage.pcode(actualID);
  		addProductpage.pName(pName);
  		addProductpage.pdDescription(description);
  		addProductpage.pQuant(qnt);
  		addProductpage.inHand(onhand);
  		addProductpage.pprice(price);
  		addProductpage.pcategory(weDriverUtility, "cpu");
  		addProductpage.Stock(datastockIn);
  		addProductpage.pSupplier(weDriverUtility, "apple");
  	//	WebDriverUtility.s
